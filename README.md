...
пользователя на его почту (Сейчас реализация - письмо сохраняется в папку emails для просроченных задач).
...
[//]: # ()
[//]: # (1&#41; Создание событий в каленларе)

[//]: # (2&#41; Поиск событий в календаре)

[//]: # (3&#41; Отображение количества событий календаре)